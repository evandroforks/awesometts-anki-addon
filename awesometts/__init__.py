...
config = Config(
    ...
    cols=[
        ...
        ('launch_browser_generator', 'integer', Qt.KeyboardModifier.ControlModifier | Qt.Key.Key_T,
         to.nullable_key, to.nullable_int),
        ('launch_browser_stripper', 'integer', None, to.nullable_key,
         to.nullable_int),
        ('launch_configurator', 'integer', Qt.KeyboardModifier.ControlModifier | Qt.Key.Key_T,
         to.nullable_key, to.nullable_int),
        ('launch_editor_generator', 'integer', Qt.KeyboardModifier.ControlModifier | Qt.Key.Key_T,
         to.nullable_key, to.nullable_int),
        ('launch_templater', 'integer', Qt.KeyboardModifier.ControlModifier | Qt.Key.Key_T,
         to.nullable_key, to.nullable_int),
